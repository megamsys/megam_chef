...
public class ShellBuilder  {	
	...
	/**
	 * The buildString iterates all the script feeders and prepares a string which
	 * can be used by a shell. It only performes this function if a script feeder "can feed" to a shell. 
	 * @param args
	 */
